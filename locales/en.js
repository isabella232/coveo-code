{
	"MissingConfig": "Unable to find any configuration in your current workspace to allow to download and upload Coveo resource(s). Please configure your workspace as explained in the extension repository : https://github.com/coveo/coveo-code",
	...
	"OptionNotValidField": "Option %s is of type : %s. Value should be a valid Coveo field. Should start with @ and followed by alpha-numeric characters",
	...
	"MimetypeDocumentation": "Specify a mimeType that determine the type of template. This mimeType create an %s template",
